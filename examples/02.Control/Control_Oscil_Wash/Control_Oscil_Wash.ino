...
// volume controls
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol1(COS2048_DATA);
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol2(COS2048_DATA);
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol3(COS2048_DATA);
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol4(COS2048_DATA);
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol5(COS2048_DATA);
Oscil<COS2048_NUM_CELLS, CONTROL_RATE> kVol6(COS2048_DATA);
